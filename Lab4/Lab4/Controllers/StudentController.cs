...
namespace Lab4.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "StudentID,FirstName,LastName,Birthday,ProgramID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "StudentID,FirstName,LastName,Birthday,ProgramID")] Student student)
        {
            if (ModelState.IsValid)
            {
